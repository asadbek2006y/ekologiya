            ...
            <div class="row">
                ...
                @foreach ($rah  as $ra )
                    ...
                    <div class="bg-white border border-top-0 p-4">
                        <div class="row">
                            <div class="col">
                                <a href="{{url('abrahbar/'.$ra->id)}}"><img src="{{asset('storage/'.$ra->img)}}" style="width:300px; height:300px;" alt=""></a>
                            </div>
                            <div class="col col-lg-6">
                               {{$ra->ism}}
                              <p>{{$ra->lavozim}}</p>
                              <p><h6>QABUL KUNI</h6>{{$ra->qabul}}</p>
                              <p><h6>MANZIL</h6>{{$ra->manzil}}</p>
                              <p><h6>TEL:</h6>{{$ra->telefon}}</p>
                              <p><h6>Joylashuv:</h6>{{$ra->viloyat}}</p>
