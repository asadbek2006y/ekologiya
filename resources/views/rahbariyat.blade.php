            ...
            <div class="row">
                ...
                @foreach ($rah  as $ra )
                    ...
                    <div class="bg-white border border-top-0 p-4">
                        <div class="row">
                            <div class="col">
                                <img src="{{asset('storage/'.$ra->img)}}" style="width:300px; height:300px;" alt="">
                            </div>
                            <div class="col col-lg-6">
                               {{$ra->ism}}
                              <p>{{$ra->lavozm}}</p>
                              <p><h6>QABUL KUNI</h6>{{$ra->qabulkuni}}</p>
                              <p><h6>QABUL VAQT</h6>{{$ra->qabulvaqti}}</p>
                              <p><h6>MANZIL</h6>{{$ra->manzil}}</p>
                              <p><h6>TEL:</h6>{{$ra->tel}}</p>
